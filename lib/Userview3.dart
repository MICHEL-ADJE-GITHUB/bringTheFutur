...
class Userview3 extends StatefulWidget {
  const Userview3({Key? key}) : super(key: key);

  @override
  _Userview3State createState() => _Userview3State();
}

class _Userview3State extends State<Userview3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Padding(
        padding: EdgeInsets.only(right: 200, bottom: 50, top: 60),
      ...
      Align(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ElevatedButton(
              onPressed: onRemoveEverything, child: Text("Remove Everything")),
        ]),
      )
    ])));
  }
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        var newNode = ARNode(
            ...
            uri: "https://github.com/MICHEL-ADJE-GITHUB/3D_models.gltb-or.glb-/blob/main/BED.glb?raw=true",
